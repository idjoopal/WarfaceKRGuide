...
public class CustomAdapterSniper extends ArrayAdapter<Custom_List_Sniper> {
	private ArrayList<Custom_List_Sniper> items;

	public CustomAdapterSniper(Context context, int textViewResourceId,
			ArrayList<Custom_List_Sniper> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Custom_List_Sniper custom_list_data = items.get(position);
...
class Custom_List_Sniper {
	private int Image_ID;
	private String Title1;
	private String Title2;

	public Custom_List_Sniper(int _Image_ID, String _Title1, String _Title2) {
