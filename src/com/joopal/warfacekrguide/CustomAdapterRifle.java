...
public class CustomAdapterRifle extends ArrayAdapter<Custom_List_Rifle> {
	private ArrayList<Custom_List_Rifle> items;

	public CustomAdapterRifle(Context context, int textViewResourceId,
			ArrayList<Custom_List_Rifle> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Custom_List_Rifle custom_list_data = items.get(position);
...
class Custom_List_Rifle {
	private int Image_ID;
	private String Title1;
	private String Title2;

	public Custom_List_Rifle(int _Image_ID, String _Title1, String _Title2) {
