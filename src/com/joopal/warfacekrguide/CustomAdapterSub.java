...
public class CustomAdapterSub extends ArrayAdapter<Custom_List_Sub> {
	private ArrayList<Custom_List_Sub> items;

	public CustomAdapterSub(Context context, int textViewResourceId,
			ArrayList<Custom_List_Sub> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.list_subtitle, null);
		}
		Custom_List_Sub custom_list_data = items.get(position);
...
class Custom_List_Sub {
	private int Image_ID;
	private String Title1;
	private String Title2;

	public Custom_List_Sub(int _Image_ID, String _Title1, String _Title2) {
