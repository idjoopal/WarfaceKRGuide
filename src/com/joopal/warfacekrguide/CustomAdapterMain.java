...
public class CustomAdapterMain extends ArrayAdapter<Custom_List_Main> {
	private ArrayList<Custom_List_Main> items;

	public CustomAdapterMain(Context context, int textViewResourceId,
			ArrayList<Custom_List_Main> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Custom_List_Main custom_list_data = items.get(position);
...
class Custom_List_Main {
	private int Image_ID;
	private String Title1;

	public Custom_List_Main(int _Image_ID, String _Title1) {
