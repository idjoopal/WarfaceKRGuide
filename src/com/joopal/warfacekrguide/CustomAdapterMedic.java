...
public class CustomAdapterMedic extends ArrayAdapter<Custom_List_Medic> {
	private ArrayList<Custom_List_Medic> items;

	public CustomAdapterMedic(Context context, int textViewResourceId,
			ArrayList<Custom_List_Medic> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Custom_List_Medic custom_list_data = items.get(position);
...
class Custom_List_Medic {
	private int Image_ID;
	private String Title1;
	private String Title2;

	public Custom_List_Medic(int _Image_ID, String _Title1, String _Title2) {
