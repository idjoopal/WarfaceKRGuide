...
public class CustomAdapterEngineer extends ArrayAdapter<Custom_List_Engineer> {
	private ArrayList<Custom_List_Engineer> items;

	public CustomAdapterEngineer(Context context, int textViewResourceId,
			ArrayList<Custom_List_Engineer> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.list_rifle, null);
		}
		Custom_List_Engineer custom_list_data = items.get(position);
...
class Custom_List_Engineer {
	private int Image_ID;
	private String Title1;
	private String Title2;

	public Custom_List_Engineer(int _Image_ID, String _Title1, String _Title2) {
